...
const App: React.FC = () => {
  ...
  /**
   * @desc Memoized shop data, enriched with calculated tiers.
   * @todo Replace RAW_SHOPS with a dynamic fetch from the backend.
   */
   ...
   */
  const handleCheckout = async (recipient: { name: string; email: string; phone: string }, message: string) => {
