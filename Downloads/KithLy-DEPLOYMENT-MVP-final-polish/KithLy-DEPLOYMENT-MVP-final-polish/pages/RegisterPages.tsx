    ...
    <div className="min-h-screen flex bg-white">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 md:p-16 relative">
            <div className="absolute top-8 left-8">
                 <AnimatedBackButton onClick={() => setView('landing')} label="Home" className="!w-auto !h-auto !py-2 !px-4 !text-xs" />
            </div>
...
export const RegisterShop: React.FC<RegisterProps> = ({ setView }) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        setView('shopPortal'); // Simulate login success
    };
             ...
             <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="relative">
                            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400">
                                <PhoneArrowDownIcon className="w-5 h-5" />
                            </div>
                            <input 
                                type="tel" 
                                placeholder="Phone"
