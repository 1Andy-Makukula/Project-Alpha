...
import { GiftIcon, CommunityIcon, SupportIcon, StarIcon, DiasporaIcon } from '../components/icons/FeatureIcons';
import { ShieldCheckIcon, DocumentTextIcon, QRIcon, MapPinIcon } from '../components/icons/NavigationIcons';
