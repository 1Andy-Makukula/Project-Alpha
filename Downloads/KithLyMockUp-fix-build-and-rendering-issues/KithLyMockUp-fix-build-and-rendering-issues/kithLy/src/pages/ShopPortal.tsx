...
import { View, ShopTier } from '../src/types';
...
const ShopPortal: React.FC<ShopPortalProps> = ({ setView, orders, onMarkAsCollected, showToast, walletStats, notifications: incomingNotifications }) => {
