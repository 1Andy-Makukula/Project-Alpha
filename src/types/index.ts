 ...
 */
export type View = 'landing' | 'customerPortal' | 'shopPortal' | 'customerDashboard' | 'shopView' | 'checkout' | 'orderSuccess' | 'about' | 'careers' | 'press' | 'terms' | 'privacy' | 'cookies' | 'registerCustomer' | 'registerShop' | 'wishlist' | 'profile' | 'contacts' | 'notifications' | 'security' | 'payments' | 'pinLocation';
