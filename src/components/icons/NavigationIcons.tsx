...
export const SmartphoneIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => (
  <svg {...iconProps(className)} {...props}>
...
export const PhoneIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => (
  <svg {...iconProps(className)} {...props}>
